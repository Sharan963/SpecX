  ...
  return (
    <div className="w-full min-h-125 bg-transparent flex flex-col items-center justify-center gap-12 px-6">
      ...
      <div className="flex flex-col items-center justify-center gap-2 text-center">
        <h1 className="text-7xl max-sm:text-4xl font-heading-alt text-[#F8F9FB]">
          Why Choose SpecX
        </h1>
      ...
      <div className="w-full max-w-7xl bg-[#1C1C24] rounded-2xl p-10
                      grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4
                      gap-32 max-sm:gap-10">

        <div className="text-center flex flex-col items-center gap-2">
          <img src={performance} className="w-50 max-sm:w-32" alt="" />
          <h3 className="text-3xl max-sm:text-xl font-heading-alt text-[#F8F9FB]">
            High Performance
          </h3>
        ...
        <div className="text-center flex flex-col items-center gap-2">
          <img src={budget} className="w-50 max-sm:w-32" alt="" />
          <h3 className="text-3xl max-sm:text-xl font-heading-alt text-[#F8F9FB]">
            Budget Friendly
          </h3>
          <p className="text-[13px] font-heading text-[#F8F9FB]/70 mt-2">
        ...
        <div className="text-center flex flex-col items-center gap-2">
          <img src={trust} className="w-50 max-sm:w-32" alt="" />
          <h3 className="text-3xl max-sm:text-xl font-heading-alt text-[#F8F9FB]">
            Trusted Parts
          </h3>
          <p className="text-[13px] font-heading text-[#F8F9FB]/70 mt-2">
        ...
        <div className="text-center flex flex-col items-center gap-2">
          <img src={support} className="w-50 max-sm:w-32" alt="" />
          <h3 className="text-3xl max-sm:text-xl font-heading-alt text-[#F8F9FB]">
            Expert Support
          </h3>
          <p className="text-[13px] font-heading text-[#F8F9FB]/70 mt-2">
