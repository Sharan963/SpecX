...
const AboutUs = () => {
  return (
    <div className="w-full min-h-125 flex flex-col md:flex-row items-center justify-between px-10 py-16 gap-12">
      ...
      <div className="md:w-1/2 flex flex-col gap-4 p-20 max-sm:p-6">
        <h2 className="text-7xl max-sm:text-4xl font-heading-alt text-[#F8F9FB]">
          Built for Real Gamers
        </h2>

        <p className="text-lg max-sm:text-base font-heading text-[#F8F9FB]/80 max-w-md">
      ...
      <div className="md:w-1/2 flex justify-center max-sm:hidden">
        <img
          src={Image}
          alt="Gaming setup"
